...
Hello Stargazers, today we look back at the year 2025 for Aurora and also check in to year 2026. This article will contain most of the same material as the [Bluefin Year End Wrapup](https://docs.projectbluefin.io/blog/bluefin-2025) with some Aurora-specific updates added.
...
Going back to the year 2024 and the month of April, Aurora got officially accepted as part of the Universal Blue Project. Legend [M2](https://github.com/m2giles) reworked the Bluefin repository to accommodate both Bluefin and Aurora and build them from the same code. Both products being built out of the same repository made sense at the time since they shared lots of similarities in configuration, preinstalled applications and other stuff.
...
Fast forward to December 2024 and this is the time where the "split" happened. Jorge cloned the Bluefin repository and spun it off into its own repository. Maintaining both Aurora and Bluefin in the same repository was not really feasible anymore since the two were diverging and the effort to make sure one didn't break when something changed was getting out of hand. So Aurora got its own repository. This was also around the time when people from the community, notably [inffy](https://github.com/inffy/), [ledif](https://github.com/ledif/) and [renner](https://github.com/renner0e/) started "showing up" and contributing to both Aurora and Universal-Blue. All 3 of them quickly became super awesome people to work with on maintaining Aurora and other parts of Universal Blue. I want to give a special shoutout to all 3 of them because without them, Aurora would not be maintainable and in its healthy, flourishing and best form it's ever been. Thank you so much.

### Chandeleer joining

In early 2025 we found our Art Director and Artist [Chandeleer](https://github.com/chandeleer1698). Launching with his first wallpaper in May 2025, he went on to create a whole universe of characters and accompanying art for Aurora, the Coneheads. Out of basically nothing, he has been rocking the wallpaper game ever since and we can't be more grateful for having such a talented artist like him. Chandeleer has been rocking it with his wallpapers since May and you can find them all shipped on your Aurora installation, free to choose, with a new one every month. On a side note, you can check out all of the characters and wallpapers in our new [Art Gallery](https://getaurora.dev/en/art) over on our website.

Please support Chandeleer on his [Ko-Fi Page](https://ko-fi.com/chandeleer) so he can make even more art.

### Our new logo

In the summer of 2025, Aurora got a small but vital and important brand refresh by two awesome artists from the community, [Delphic Melody](https://github.com/delphicmelody) and [zandrro](https://codeberg.org/achronent). They took the old logo which was AI generated (crucify me, but sadly I'm not an artist) and turned it into a human-made and the most awesome version ever. Also a huge thank you to both of them for their contributions.
...
So if you are interested chatting about Linux and specifically Aurora stuff, please join us @ [https://discord.getaurora.dev](https://discord.getaurora.dev)
...
We are putting in effort to have less stuff baked into the images and instead provide curated experiences through Bazaar for Flatpaks and [Bold Brew](https://github.com/Valkyrie00/bold-brew) for command-line apps. Shout out to [Vito Castellano](https://github.com/Valkyrie00) for continuing to improve the Linux brew experience with Bold Brew!

![image](/img/user-attachments/59e24766-0885-4fc8-a6e9-87339672487c.png)
...
And finally, thanks to our [custom tap](https://github.com/ublue-os/homebrew-tap) we are investigating on how to bring `aurora-cli` to MacOS, so that you can have these same convenience tools on multiple operating systems. James [has a prototype](https://github.com/hanthor/bluefin-cli) that you can check out.
...
![aurora](/img/user-attachments/c1359b27-a04b-4ca4-82b7-ca669890c653.png)

![contributors](/img/user-attachments/d096c0bf-4dea-4dca-a3d5-d41c8ac80bd9.png) ![issues](/img/user-attachments/3d93c1f3-eb12-44c5-bd0f-08fef60e0c2b.png) ![commits](/img/user-attachments/611291de-4cea-4b20-8050-8f0dcc5b2109.png)
